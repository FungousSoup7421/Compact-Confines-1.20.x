...
public class AlloyerScreen extends AbstractContainerScreen<AlloyerMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CompactConfines.MOD_ID, "texture/gui/alloyer_gui.png");

    public AlloyerScreen(AlloyerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
